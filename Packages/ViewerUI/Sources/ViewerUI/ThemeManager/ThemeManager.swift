...
public class ThemeManager {
    ...
    public func applyCustomColors(_ colors: CustomColorScheme) {
        customColors = colors
        currentTheme = .custom
        updateColorScheme()
        persistSettings()
    ...
    public func increaseFontSize() {
        adjustFontSize(multiplier: fontSizeMultiplier + 0.1)
    }
    ...
    public func resetFontSize() {
        adjustFontSize(multiplier: 1.0)
    }

    /// Set theme (convenience method)
    public func setTheme(_ theme: Theme) {
        applyTheme(theme)
    }

    /// Load user preferences from storage
    public func loadUserPreferences() async {
        loadPersistedSettings()
    }

    /// Update accessibility settings from system
    public func updateAccessibilitySettings(highContrast: Bool, reduceMotion: Bool) async {
...
public enum ColorToken: String, CaseIterable, Codable {
    ...
    public var lightColor: Color {
        ...
        case .tertiary: return Color.gray.opacity(0.6)
        case .background: return .white
        case .secondaryBackground: return Color.gray.opacity(0.1)
    ...
    public var adaptiveColor: Color {
        ...
        case .tertiary: return Color.gray.opacity(0.5)
    ...
    public var highContrastColor: Color {
        ...
        case .tertiary: return Color.gray.opacity(0.6)
        case .background: return .white
        case .secondaryBackground: return Color.gray.opacity(0.15)
        case .accent: return .blue
        case .error: return .red
        case .warning: return .orange
        case .success: return .green
...
// MARK: - Custom Color Scheme Protocol

public protocol CustomColorScheme {
