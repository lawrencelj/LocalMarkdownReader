...
final class LineNumberTextViewTests: XCTestCase {
    ...
    private func makeTextView(
        ...
        let textView = LineNumberTextView(frame: NSRect(x: 0, y: 0, width: 600, height: 400), textContainer: textContainer)
    ...
    func testGutterEnabled_reservesExclusionSpace() {
        ...
        XCTAssertEqual(textView.textContainer?.exclusionPaths.count, 1,
                       "Gutter should reserve space via one exclusion path")
        XCTAssertGreaterThanOrEqual(textView.gutterWidth, 36,
    ...
    func testGutterDisabled_releasesExclusionSpace() {
        ...
        XCTAssertTrue(textView.textContainer?.exclusionPaths.isEmpty ?? false,
    ...
    func testLineNumberFont_isMonospacedSystemFontAt11pt() {
        ...
        XCTAssertEqual(textView.lineNumberFont.fontName, expectedFont.fontName,
                       "Line number font should be monospaced system font")
        XCTAssertEqual(textView.lineNumberFont.pointSize, 11,
    ...
    func testLineNumberFont_updatesWhenFontSizeChanges() {
        ...
        XCTAssertEqual(textView.lineNumberFont.pointSize, 16.5,
    ...
    func testBaseTextColor_alphaIsAtMostHalf() {
        ...
        XCTAssertLessThanOrEqual(textView.lineNumberColor.alphaComponent, 0.5,
    ...
    func testCurrentLineColor_usesAccentAtFullOpacity() {
        ...
        XCTAssertEqual(textView.currentLineColor, NSColor.controlAccentColor,
                       "Current line color should use system accent color")
        XCTAssertEqual(textView.currentLineColor.alphaComponent, 1.0,
    ...
    func testSeparatorColor_isConfigured() {
        ...
        XCTAssertEqual(textView.separatorColor, NSColor.separatorColor,
    ...
    func testGutterWidth_minimumIs36pt() {
        ...
        XCTAssertGreaterThanOrEqual(textView.requiredGutterWidth, 36,
    ...
    func testGutterWidth_accommodatesHighDigitCounts() {
        ...
        XCTAssertGreaterThanOrEqual(thickness4Digits, textView2Lines.requiredGutterWidth,
    ...
    func testCurrentLineUsesAccentColor() {
        ...
        XCTAssertEqual(textView.currentLineColor.alphaComponent, 1.0, accuracy: 0.01,
                       "Current line color should be at full opacity")
        XCTAssertLessThanOrEqual(textView.lineNumberColor.alphaComponent, 0.5,
                                 "Base text color should be at subdued opacity (≤ 0.5)")
        XCTAssertNotEqual(textView.currentLineColor, textView.lineNumberColor,
    ...
    func testMovingCursorUpdatesHighlight() {
        ...
        XCTAssertEqual(textView.currentLine, 4,
    ...
    func testMultiLineSelectionHighlightsInsertionPoint() {
        ...
        XCTAssertEqual(textView.currentLine, lineNumber,
                       "Only the insertion point line should be highlighted")
        XCTAssertTrue(textView.currentLine! >= 1 && textView.currentLine! <= 5,
    ...
    func testRendering_gutterAndSourceTextAreBothVisible() {
        ...
        XCTAssertGreaterThanOrEqual(distinctColorCount(in: rep, region: gutterRegion), 2,
        ...
        XCTAssertGreaterThanOrEqual(distinctColorCount(in: rep, region: textRegion), 2,
    ...
    func testRendering_gutterScrollsWithText() {
        ...
        XCTAssertEqual(scrollView.contentView.bounds.origin.y, 500, accuracy: 1,
