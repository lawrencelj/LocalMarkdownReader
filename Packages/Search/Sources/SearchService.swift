...
public class SearchService: ObservableObject {
    ...
    public func indexDocument(_ document: DocumentModel) async {
        await performanceMonitor.trackOperation("index_document") {
    ...
    public func highlightMatches(_ content: NSAttributedString, query: String) -> NSAttributedString {
    ...
    public func updateDocumentIndex(_ document: DocumentModel) async {
        await performanceMonitor.trackOperation("update_index") {
